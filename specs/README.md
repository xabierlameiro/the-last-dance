...
| Spec | Title | Status |
| ---- | ----- | ------ |
| [001](001-header-widgets-fixes.md) | Header widgets & weather panel fixes | Ready to implement |
| [002](002-seo-technical-foundation.md) | Technical SEO foundation + GSC anomalies | Decisions proposed, needs sign-off |
| [003](003-adsense-content-remediation.md) | AdSense "low value content" remediation | Blocked on decision D1 |
| [004](004-knowledge-panel-entity.md) | "Xabier Lameiro" Google entity / Knowledge Panel | Long-horizon program |
| [005](005-nextjs16-upgrade-decision.md) | Next.js 16 upgrade go/no-go | **Decided: NO-GO for now** |

Recommended execution order: 001 (quick wins) → 002 → 003 → 004 (continuous). 005 requires no work now.
