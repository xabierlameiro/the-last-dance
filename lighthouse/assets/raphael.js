   ...
   return (
      ...
      (j.on = function (a, b) {
         ...
         for (var c = a.split(e), d = i, f = 0, h = c.length; h > f; f++)
            (d = d.n), (d = (d.hasOwnProperty(c[f]) && d[c[f]]) || (d[c[f]] = { n: {} }));
   ...
   (function (a, b) {
      ...
      function e(a, b, c) {
         function e() {
            ...
            return h[y](g)
               ? (d(i, g), c ? c(h[g]) : h[g])
               : (i.length >= 1e3 && delete h[i.shift()], i.push(g), (h[g] = a[C](b, f)), c ? c(h[g]) : h[g]);
         }
         return e;
      }
      function f() {
      ...
      function l(a, c, d) {
         ...
         for (q = 0; l + 1 > q; q++)
            (r = b.findDotsAtSegment.apply(b, c.concat(q / l))), n.push({ x: r.x, y: r.y, t: q / l });
         for (q = 0; j > q; q++)
            for (var s = 0; l > s; s++) {
               var t = m[q],
                  u = m[q + 1],
                  ...
                  if (i[y](z) && (ca[y](z) || d.paper.customAttributes[y](z)))
                     switch (((r[z] = d.attr(z)), null == r[z] && (r[z] = ba[z]), (s[z] = i[z]), ca[z])) {
                        ...
                        case 'transform':
                           ...
                           if (J)
                              for (
                                 r[z] = J.from, s[z] = J.to, t[z] = [], t[z].real = !0, w = 0, x = r[z].length;
                                 x > w;
                                 w++
                              )
                        ...
                        default:
                           for (
                              M = [][D](i[z]), N = [][D](r[z]), t[z] = [], w = d.paper.customAttributes[z].length;
                              w--;
      ...
      if (
         ...
         (b.type =
            z.win.SVGAngle ||
            z.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
               ? 'SVG'
               : 'VML'),
         'VML' == b.type)
      ) {
      ...
      var sa = function (a) {
         ...
         wa = function (a, c, d) {
            if (
               (null == c && b.is(a, 'object') && 'r' in a && 'g' in a && 'b' in a && ((d = a.b), (c = a.g), (a = a.r)),
               null == c && b.is(a, T))
            ) {
               var e = b.getRGB(a);
               (a = e.r), (c = e.g), (d = e.b);
      ...
      (b.getRGB = e(function (a) {
         ...
         return j
            ? (j[2] &&
                 ((e = _(j[2].substring(5), 16)), (d = _(j[2].substring(3, 5), 16)), (c = _(j[2].substring(1, 3), 16))),
              j[3] &&
               ...
               e.length ||
                  H(a).replace(ga, function (a, b, c) {
                     ...
                     if (
                        ...
                        'm' == g &&
                           f.length > 2 &&
                           (e.push([b][D](f.splice(0, 2))), (g = 'l'), (b = 'm' == b ? 'l' : 'L')),
                        'r' == g)
                     )
                        e.push([b][D](f));
         ...
         (function (a) {
            ...
            (a.add = function (a, b, c, d, e, f) {
               ...
               (a.split = function () {
                  ...
                  return (
                     0 > g
                        ? ((a.rotate = b.deg(M.acos(g))), 0 > f && (a.rotate = 360 - a.rotate))
               ...
               return z.doc.addEventListener
                  ? function (a, b, c, d) {
                       ...
                       if ((a.addEventListener(b, e, !1), E && K[b])) {
                          var f = function (b) {
                             for (
                                var e = Sa(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length;
                                h > g;
                                g++
                             )
      ...
      (Xa.drag = function (c, d, e, f, g, h) {
         ...
         (Xa.undrag = function () {
            for (var c = Za.length; c--; )
               Za[c].el == this &&
                  (this.unmousedown(Za[c].start), Za.splice(c, 1), a.unbind('raphael.drag.*.' + this.id));
      ...
      var _a = function (a, c, d, e, f, g, h, k, l) {
            return null == l
               ? i(a, c, d, e, f, g, h, k)
               : b.findDotsAtSegment(a, c, d, e, f, g, h, k, j(a, c, d, e, f, g, h, k, l));
         },
         ab = function (a, c) {
      ...
      (Xa.animateWith = function (a, c, d, e, f, g) {
         ...
         (Xa.pause = function (b) {
            for (var c = 0; c < fb.length; c++)
               fb[c].el.id != this.id ||
                  (b && fb[c].anim != b) ||
                  (a('raphael.anim.pause.' + this.id, this, fb[c].anim) !== !1 && (fb[c].paused = !0));
            return this;
         }),
         ...
         (Xa.stop = function (b) {
            for (var c = 0; c < fb.length; c++)
               fb[c].el.id != this.id ||
                  (b && fb[c].anim != b) ||
                  (a('raphael.anim.stop.' + this.id, this, fb[c].anim) !== !1 && fb.splice(c--, 1));
            return this;
         }),
         ...
         (u.print = function (a, c, d, e, f, g, h, i) {
            ...
            if ((b.is(e, 'string') && (e = this.getFont(e)), e)) {
               ...
               for (
                  ...
                  x &&
                     x.d &&
                     (n += b.transformPath(x.d, ['t', l * j, r * j, 's', j, j, p, s, 't', (a - p) / j, (c - s) / j]));
               }
            }
      ...
      if (!a || a.svg) {
         ...
         (A.prototype = B),
            ...
            (a._engine.rect = function (a, b, c, d, e, f) {
               ...
               var h = new A(g, a);
               return (
                  (h.attrs = { x: b, y: c, width: d, height: e, rx: f || 0, ry: f || 0, fill: 'none', stroke: '#000' }),
                  (h.type = 'rect'),
                  q(g, h.attrs),
                  h
               );
         ...
         (D.prototype = E),
            ...
            (E.transform = function (b) {
               ...
               if ((h.translate(1, 1), l || k || 'image' == this.type))
                  if (
                     ((i.matrix = '1 0 0 1'), (i.offset = '0 0'), (g = h.split()), (k && g.noRotation) || !g.isSimple)
                  ) {
