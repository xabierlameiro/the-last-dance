...
const es = {
    ...
    'githubStars.open': 'Estado del repositorio',
    'githubStars.repo': 'xabierlameiro/the-last-dance',
    'githubStars.tagline': 'El código de esta web. Hecho a la vista de todos.',
    'githubStars.stars': 'estrellas',
    'githubStars.forks': 'forks',
    'githubStars.watchers': 'siguiendo',
    'githubStars.issues': 'issues',
    'githubStars.updated': 'Último commit {when}',
    'githubStars.cta': 'Dar una estrella',
    'starPrompt.title': 'the-last-dance',
    'starPrompt.message': '¿Te ha servido de algo? Una estrella ayuda a que otros lo encuentren.',
    'starPrompt.accept': 'Dar estrella',
    'starPrompt.dismiss': 'Ahora no',
