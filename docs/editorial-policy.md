...
date, the build fails on a missing field, a `title` over 60 characters or a `description` over 155. Older posts only warn.
...
| 3   | Why a path-segment facet cannot be redirected, noindexed or disallowed. Drafted 2026-09-18 as `data/blog/tag-facet-urls-query-parameter`; Results written 2026-09-23 and no longer blocking. The measurement is a negative one and the post says so: the facet impressions it was going to compare had already been flat at zero since 25 July, and the facet URLs' last crawls (5 Sep, 18 Jul) both predate the change, so Google has not seen the redirects yet | SDD-009, PRs #186 / #189, result of `tag-facets-as-query-param` (live 18–19 Sep 2026, #214 / #215 / #217)                                                                                                                                                                                                                                                  | Now                                          | pass · pass · pass · pass                                                                                  |
