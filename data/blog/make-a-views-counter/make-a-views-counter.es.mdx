...
tags: ['node']
locale: 'es'
excerpt: 'Cree un contador de vistas para su blog con google analytics y nextjs api route. Uso de BetaAnalyticsDataClient desde la API de datos de Google Analytics'
description: 'Cree un contador de vistas para su blog con google analytics y nextjs api route. Uso de BetaAnalyticsDataClient desde la API de datos de Google Analytics'
...
Aquí no explicamos cómo crear una cuenta de GA, puedes seguir este [tutorial](https://support.google.com/analytics/answer/1008015?hl=en 'GA Link') para hacerlo.

## 1. Cree tu api para obtener los datos usando la clase BetaAnalyticsDataClient
