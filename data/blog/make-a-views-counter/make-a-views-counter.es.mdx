...
description: 'Añade un contador de visitas a tu blog Next.js con la API de datos de Google Analytics (BetaAnalyticsDataClient) tras una API route: autenticación, la consulta del informe y el cacheo explicados.'
