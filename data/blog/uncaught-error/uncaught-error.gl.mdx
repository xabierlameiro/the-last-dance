...
alternate: [{ lang: 'en', url: 'uncaught-error-minified-react-error'  }, { lang: 'es', url: 'error-no-detectado-react-minificado' }]
---

# Erro non detectado: erro de reacción minimizado

Ao usar React, pode atopar o seguinte erro: `Erro non detectado: erro de React minimizado, visite https://reactjs.org/docs/erro-decoder.html?invariant=425 para ver a mensaxe completa ou use a contorna de desenvolvemento non minimizado para erros completos e advertencias útiles adicionais.
