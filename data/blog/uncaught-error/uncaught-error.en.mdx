...
{/* TODO(xabier): screenshot of the minified #425 error in the production console vs. the full dev message — this is the E-E-A-T "here is what I actually saw" moment. */}
...
The example below is the date case — the one I hit on this very site's clock widget.

## The code that caused the error

{/* TODO(xabier): one sentence in your own voice — where this bit you (the desktop clock widget) and how long it took to track down. Keep it specific and first-hand. */}
...
{/* TODO(xabier): screenshot of the dev-mode "Text content did not match. Server: … Client: …" warning pointing at the element. */}
