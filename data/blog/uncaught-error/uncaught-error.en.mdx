...
faq:
    ...
    - question: 'Are #418, #422 and #425 the same error?'
      answer: 'They are the same family of hydration errors, and React distinguishes them by how far it had to fall back. #418 is the hydration failure itself; #422 means React recovered by client-rendering from the nearest Suspense boundary; #423 means it had to client-render the entire root; #425 is the text-content mismatch. The debugging approach is identical: run a dev build and reconcile server and client output.'
---
