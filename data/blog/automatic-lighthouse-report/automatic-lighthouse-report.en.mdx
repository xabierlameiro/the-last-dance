...
To always have a current snapshot of the sitemap of my site I use playwright to check the sitemap, have the link tree and create a flowchart using Treant.js as you can see [here](https://lighthouse.xabierlameiro.com 'Lighthouse report example').
