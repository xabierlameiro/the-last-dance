...
Una manera fácil de tener automatizados los informes de Lighthouse es manejar desde un script la herramienta de Google [Lighthouse](https://github.com/GoogleChrome/lighthouse): pasar la auditoría a una web y guardar los resultados para poder compararlos con los de otras ejecuciones.

Conviene ser preciso con el nombre, porque los dos se confunden: esto usa **Lighthouse**, el motor de auditoría. [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) es otro proyecto — los paquetes `@lhci/cli` y `@lhci/server`, que existen para almacenar ejecuciones y compararlas contra un presupuesto. Si lo que quieres son aserciones y un servidor de histórico en vez de un script que controlas tú, esa es la herramienta.
