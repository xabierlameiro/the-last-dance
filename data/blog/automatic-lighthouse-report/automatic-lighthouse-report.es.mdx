...
Para tener siempre una foto actual del sitemap de mi web utilizo playwright para revisar el sitemap, tener el arbol de enlaces y crear un organigrama usando Treant.js como puedes ver [aquí](https://lighthouse.xabierlameiro.com 'Reporte de lighthouse').
