...
description: 'Traduce as túas URLs por idioma para un sitio Next.js totalmente internacionalizado con páxinas MDX estáticas: mapea slugs localizados, mantén os canónicos limpos e liga idiomas con hreflang.'
