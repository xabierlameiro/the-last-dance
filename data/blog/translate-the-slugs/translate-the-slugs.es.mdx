...
description: 'Traduce tus URLs por idioma para un sitio Next.js totalmente internacionalizado con páginas MDX estáticas: mapea slugs localizados, mantén los canónicos limpios y enlaza idiomas con hreflang.'
