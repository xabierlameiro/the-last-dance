...
description: 'Implementa un tema escuro en Next.js con variables CSS e un evento de cambio de tema: sen parpadeo do tema equivocado e sen librarías pesadas. Guía paso a paso co código completo.'
