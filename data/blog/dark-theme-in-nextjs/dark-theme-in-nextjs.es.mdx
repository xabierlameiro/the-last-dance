...
description: 'Implementa un tema oscuro en Next.js con variables CSS y un evento de cambio de tema: sin parpadeo del tema equivocado y sin librerías pesadas. Guía paso a paso con el código completo.'
