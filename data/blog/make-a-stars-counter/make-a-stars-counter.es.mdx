---
title: 'Contador de estrellas de un repositorio de GitHub'
...
description: 'Crea un contador de estrellas de GitHub para tu sitio con una API route de Next.js y Octokit: cachea la API de GitHub para evitar rate limits y muestra el número de estrellas en vivo. Código incluido.'
...
# Contador de estrellas de un repositorio de GitHub
