---
title: 'Contador de estrelas dun repositorio de GitHub'
...
description: 'Crea un contador de estrelas de GitHub para o teu sitio cunha API route de Next.js e Octokit: cachea a API de GitHub para evitar rate limits e mostra o número de estrelas en vivo. Código incluído.'
...
# Contador de estrelas dun repositorio de GitHub
