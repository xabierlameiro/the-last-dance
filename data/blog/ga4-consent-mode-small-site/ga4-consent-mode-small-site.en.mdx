...
**The view counter was reading the smaller number.** Each post shows a view count that comes from the GA4 Data API. It only ever counted page views from visitors who accepted cookies. It isn't wrong, but it's a count of consenting readers, not of readers.
