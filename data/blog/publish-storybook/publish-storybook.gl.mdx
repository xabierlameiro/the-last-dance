...
Ese par `ComponentStory` / `ComponentMeta` é a API de Storybook 6 e está **deprecada** desde Storybook 7. O substituto é CSF3, e desde entón non cambiou — igual no 8, no 9 e no 10 (10.5 é o major actual ao escribir isto; esta web segue no 8.6). Elimina o boilerplate do template: unha story é só un obxecto con `args`:
