...
Ese par `ComponentStory` / `ComponentMeta` es la API de Storybook 6 y está **deprecada** desde Storybook 7. El sustituto es CSF3, y desde entonces no ha cambiado — igual en el 8, el 9 y el 10 (10.5 es el major actual al escribir esto; esta web sigue en el 8.6). Elimina el boilerplate del template: una story es solo un objeto con `args`:
