...
description: 'Xera documentación dos teus compoñentes React automaticamente con JSDoc e publícaa como sitio estático: a configuración, as anotacións que importan e como despregala.'
...
Para ver un exemplo de saída podes facer click arriba onde di Docs ou visitar [a documentación dos meus compoñentes de React](https://docs.xabierlameiro.com 'Documentación dos meus compoñentes de React')
