...
**Actualización, setembro de 2026.** Os tres issues de abaixo están pechados e os arranxos saíron en Next.js 16.3.0 (a #95094 e a #94919 entraron en `16.3.0-canary.97` o 25 de xullo; a #94890, dous días despois). As medidas tomáronse coas fugas aínda abertas, contra as versións dos informes (Next 15.5.11–16.3.0-canary.50, Node 20/22/24), e quedan porque o método sobrevive aos bugs. Se estás en 16.3.x e segues crecendo, sube primeiro a 16.3.5 — saíu o 11 de setembro e arranxa a retención de `use cache` que se segue en [vercel/next.js#97938](https://github.com/vercel/next.js/issues/97938). Segues crecendo despois? Tes outra. Para saber que ruta crece e que retén a memoria, executa `npx next-leak .` ([código e límites](https://github.com/xabierlameiro/next-leak)).
