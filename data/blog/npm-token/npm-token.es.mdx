...
alternate:
    [
        { lang: 'en', url: 'npm-token-solution-error' },
        { lang: 'gl', url: 'npm-token-solucion-erro' },
    ]
---
...
<br />
Pero es necesario crear un archivo .npmrc en la raiz del proyecto y añadir el siguiente
contenido:
